...
class simple_html_dom_node
{
	...
	function addClass($class)
	{
		...
		if (is_array($class)) {
			...
			// Invalid type for $class, do nothing
		}
	}
...
class simple_html_dom
{
	...
	protected function parse_charset()
	{
		...
		// Skipping get_last_retrieve_url_contents_content_type() because it is undefined.
		// If you need to detect charset from HTTP headers, implement this function or use another method.
